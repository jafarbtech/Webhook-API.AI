        ...
        if (req.body.result && req.body.result.parameters && req.body.result.parameters.city) {
            ...
            http.get(url, function(resp) {
                ...
                resp.on('end', function() {
                    ...
                    displayText = 'Today in ' + fbResponse.query.results.channel.location.city + ': ' + fbResponse.query.results.channel.item.condition.text + ', the temperature is ' + fbResponse.query.results.channel.item.condition.temp + '°' + fbResponse.query.results.channel.units.temprature + ' ('+((5/9) * (fbResponse.query.results.channel.item.condition.temp-32)).toFixed(2)+'°C), the humidity is ' + fbResponse.query.results.channel.atmosphere.humidity + '%, the wind speed is ' + fbResponse.query.results.channel.wind.speed + ' ' + fbResponse.query.results.channel.units.speed + ' ('+(fbResponse.query.results.channel.wind.speed/0.62137).toFixed(2)+' kmph). Would you like to know more?';
